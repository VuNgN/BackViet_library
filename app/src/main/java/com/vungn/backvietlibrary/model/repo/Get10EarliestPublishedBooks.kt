...
class Get10EarliestPublishedBooks @Inject constructor(
    ...
    override fun getFromDatabase(): Flow<List<BookEntity>> = bookDao.get10EarliestPublishedBook()
